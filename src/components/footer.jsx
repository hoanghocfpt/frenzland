        ...
        <footer>
            ...
            <div className="social_rating">
                ...
                <div className="list">
                    ...
                    <a href="https://x.com/Frenzland_" className="item" target="_blank">
                    <svg
                        viewBox="0 0 16 16"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="#000000"
                    ...
                    <a
                    href="https://www.tiktok.com/@frenzland_"
                    className="item"
                    target="_blank"
                    >
                    <svg
            ...
            <div className="link_footer">
                ...
                |
                <li>
                    <a href="javascript:void(0)">IP RIGHTS</a>
                </li>
                |
                <li>
                ...
                <span className="copyright">COPYRIGHT @2023 - FRENZLAND</span>
